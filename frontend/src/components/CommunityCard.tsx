...
export const CommunityCard: FC<Props> = ({ community, onClick }) => (
  <button
    onClick={onClick}
    className="w-full text-left bg-white/4backdrop-blur-xl border border-white/10 rounded-2xl p-5 shadow-soft hover:-translate-y-0.5 hover:bg-white/[0.07] hover:border-white/20 transition flex items-center justify-between"
  >
